...
# import nome da bibliote # importa todas as funções.
# Para importar só a função que se quer utliza-se o comando:
# from nome da biblioteca import o nome da função # importa apenas uma função específica.

# ex.: módulo "math", módulo com funções matemáticos.
...
# Exemplo 1:
# from math import sqrt, ceil, floor  # Ao utilizar dessa forma não é mais preciso digitar "math.srqt()". Pode ser digitada diretamente a função.
    # import math # Ao utilizar dessa forma é necessário espcificar o nome do módulo e da função, "math.sqrt()".
