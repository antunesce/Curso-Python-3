...
ex.7: 'frase[9::3]' -> irá iniciar no 9 e como não tem indicação de até onde se quer, ele entendi que deve ir até o final. O ':3' indica que irá pular de 3 em 3, pegará sempre a terceira posição seguinte. Nesse exemplo será "v e P h".
