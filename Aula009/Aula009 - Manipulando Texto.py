...
na memória irá ser quebrado em miniespaços e cada caractere será colocado nesses espaços.
...
ex.3: 'frase[9:21] -> não irá dar erro já que a última posição é a 20 e como o comando irá pegar até a posição anteriar a pedida (posição :21) dará certo. nesse exemplo será "video Python".
